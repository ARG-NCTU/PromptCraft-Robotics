...
Procedure:
{
    Do phase 1: {
        Do phase 1-1: {
            "set_altitude" (Altitude: 5 meters)
        }
    } Do phase 2 if 1 success: {
        Do phase 2-1: {
            "waypoint_tracking" (Target: solar_panel_array)
        } Do phase 2-2 if 2-1 success: {
            Do phase 2-2-1: {
                "explore_pattern_block" (Pattern: lawnmower, Step Distance: 30 meters, Step Length: 50 meters)
            }
        } Do phase 2-3 if 2-2 success: {
            "waypoint_landing"
        }
...
![](/examples/figs/chatgpt/inspection_trial_5.png)
