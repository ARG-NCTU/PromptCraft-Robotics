...
Procedure:
{
    Do Phase 1: Takeoff and Reach Inspection Altitude
    {
        Do Phase 1-1: Check Altitude
        Do Phase 1-2 if 1-1 fails: Set Altitude
        Do Phase 1-3 if 1-1 success:
        {
            Do Phase 1-3-1: Move Forward
            Do Phase 1-3-2 if 1-3-1 success: Rotate Right
        }
    }
    Do Phase 2:
    {
        Do Phase 2-1: Move Forward
        Do Phase 2-2 if 2-1 success:
        {
            Do Phase 2-2-1: Move Forward
            Do Phase 2-2-2 if 2-2-1 success: Rotate Left
        }
    }
    Do Phase 3:
    {
        Do Phase 3-1: Move Forward
        Do Phase 3-2 if 3-1 success:
        {
            Do Phase 3-2-1: Move Forward
            Do Phase 3-2-2 if 3-2-1 success: Rotate Right
        }
    }
    Do Phase 4:
    {
        Do Phase 4-1: Move Forward
        Do Phase 4-2 if 4-1 success:
        {
            Do Phase 4-2-1: Move Forward
            Do Phase 4-2-2 if 4-2-1 success: Rotate Left
        }
    }
    Do Phase 5:
    {
        Do Phase 5-1: Move Forward
        Do Phase 5-2 if 5-1 success: Go Home
    }
}
...
![](/examples/figs/chatgpt/inspection_trial_1.png)
