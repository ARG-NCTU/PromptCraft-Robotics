...
Procedure:
{
    Do phase 1: {
        ...
        Do phase 2-1: {
            Do phase 2-1-1: {
                "object_in_view"
                Variable: obj_list, obj_locs
            } Do phase 2-1-2 if 2-1-1 success: {
                "report_error"
                Variable: distance
                Condition: distance > threshold
            } Do phase 2-1-3 if 2-1-2 failed: {
                "waypoint_tracking"
                Variable: obj_list, obj_locs
            }
        } Do phase 2-2 if 2-1 success: {
            "object_in_view"
            Variable: obj_list, obj_locs
            Do phase 2-2-1 if obj_list contains "red_ball": {
                "waypoint_takeoff"
            }
        } Do phase 2-3 if 2-2 success: {
            Do phase 2-3-1: {
...
![](/examples/figs/chatgpt/object_navigation_trial_4.png)
