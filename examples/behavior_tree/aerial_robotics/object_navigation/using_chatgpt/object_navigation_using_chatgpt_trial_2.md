...
Procedure:
{
    Do phase 1: {
        Do phase 1-1: {
            "object_in_view" with target object = "red_ball"
        ...
        Do phase 2-1: {
            "object_in_view" with target object = "red_ball"
        } Do phase 2-2 if 2-1 failed: {
            "explore_rotate"
        }
    } Do phase 3 if 2 failed: {
        Do phase 3-1: {
            "object_in_view" with target object = "red_ball"
        } Do phase 3-2 if 3-1 failed: {
            "explore_rotate"
        }
    } Do phase 4 if 3 failed: {
        Do phase 4-1: {
            "object_in_view" with target object = "red_ball"
        } Do phase 4-2 if 4-1 failed: {
            "explore_rotate"
        }
...
![](/examples/figs/chatgpt/object_navigation_trial_2.png)
